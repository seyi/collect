...
class ACManualProjectCreatorDialog(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (url != null && userName != null && password != null) {
            //Bypass the UI and directly create the project
            handleAddNewProject2(url,userName,password)
    ...
    private fun handleAddNewProject2(url: String, username: String, password: String) {
